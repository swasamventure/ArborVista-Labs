...
The Phase A page works on GitHub Pages. Reservation, calendar, reporting, and other API-backed pages continue to require `python Backend/server.py` locally until Supabase deployment.
