...
payload={'check_in':'2030-02-10','check_out':'2030-02-13','adults':'4','children':'2','vehicles':'2','first_name':'Test','last_name':'Guest','email':'test@example.com','phone':'5125551212','legal_name':'Test Guest','electronic_signature':'Test Guest','agreement_date':'2026-07-23','special_requests':'QA'}
...
a=availability('prop_arbor_vista','2030-02-11','2030-02-12',db_path=tmp)
...
try:
    p=dict(payload);p['check_in']='2030-03-01';p['check_out']='2030-03-03';p['adults']='7';p['children']='2';server.create_booking(p); over=False
except ValueError: over=True
ck('More than eight guests rejected',over)
p=dict(payload);p['check_in']='2030-03-01';p['check_out']='2030-03-03';p['adults']='6';p['children']='2';r2=server.create_booking(p)
